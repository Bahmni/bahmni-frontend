...
describe('Microfrontend Loader Tests', () => {
  ...
  test('should render mf in appropriate containers', async () => {
    ...
    expect(domDocument.body.querySelector('#test-mf1').querySelector('#test-mf1-element')).not.toBeNull();
    expect(domDocument.body.querySelector('#test-mf2').querySelector('#test-mf2-element')).not.toBeNull();
